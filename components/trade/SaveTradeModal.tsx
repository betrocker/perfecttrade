            ...
            >
              ...
              <View className="mb-4">
                ...
                >
                  <Text
                    className={
                      currencyPair ? "text-txt-primary" : "text-txt-tertiary"
                    }
                  >
                    ...
                    <ScrollView>
                      {currencyPairs.map((pair, index) => (
                        <TouchableOpacity
                          ...
                          style={{
                            borderBottomWidth:
                              index < currencyPairs.length - 1 ? 1 : 0,
                ...
                <View className="flex-row">
                  ...
                  >
                    <Text
                      ...
                      style={{
                        color: direction === "LONG" ? "#00F5D4" : "#8B95A5",
                      }}
                    >
                      LONG
                    </Text>
                    ...
                    style={{
                      backgroundColor:
                        direction === "SHORT"
                          ...
                          : "transparent",
                      borderColor:
                        direction === "SHORT" ? "#EF4444" : "#3A4F64",
                    }}
                  >
                    <Text
                      className="text-center font-bold"
                      style={{
                        color: direction === "SHORT" ? "#EF4444" : "#8B95A5",
                      }}
                    >
                      SHORT
                    </Text>
              ...
              <View className="mb-4">
                ...
                <View className="bg-bg-tertiary rounded-lg p-4 border border-border">
                  ...
                  <View className="flex-row mb-3">
                    <View className="flex-1 mr-2">
                      <Text className="text-txt-tertiary text-xs mb-1">
                        Entry Price
                      </Text>
                      <TextInput
