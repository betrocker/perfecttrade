...
const WEEKLY_ITEMS: ChecklistItem[] = [
    ...
    },
    {
        ...
        description: 'Is price near a round psychological level (e.g., 1.0000, 1.1000)?',
        percentage: 5,
    },
    {
        id: 'w5',
...
const DAILY_ITEMS: ChecklistItem[] = [
    {
        id: 'd1',
        label: 'Trend',
        description: 'Is the daily trend clearly identified and aligned with weekly?',
        percentage: 10,
    },
    {
        id: 'd2',
...
const ENTRY_ITEMS: ChecklistItem[] = [
    {
        id: 'e1',
        label: 'SOS',
        description: 'Is there a clear Sign of Strength (bullish) or Sign of Weakness (bearish)?',
        percentage: 10,
    },
    {
        id: 'e2',
        label: 'Engulfing Candlestick (30m, 1H, 2H, 4H)',
        description: 'Is there a strong engulfing candlestick pattern on relevant timeframes?',
        percentage: 10,
    },
];
        ...
        if (checkedItems.has(item.id)) {
            ...
            Alert.alert(
                ...
                [
                    ...
                    { text: 'Yes', onPress: () => setCheckedItems(new Set(checkedItems).add(item.id)) },
                ]
            );
        }
    };
